import type {
  ...
  ProviderResult,
  ProviderSupport,
} from "cursor-free:provider";
import type { PluginContext } from "cursor-free:plugin";
import { HttpError, streamOpenAiResponses } from "cursor-free:protocol/openai-responses";
